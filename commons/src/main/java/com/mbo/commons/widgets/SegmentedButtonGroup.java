...
public class SegmentedButtonGroup extends LinearLayout
{
    ...
    {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.SegmentedButtonGroup, 0, 0);
        try
        {
            mCheckedId = a.getResourceId(R.styleable.SegmentedButtonGroup_checkedButtonId, View.NO_ID);
    ...
    private class PassThroughHierarchyChangeListener implements ViewGroup.OnHierarchyChangeListener
    {
        ...
        {
            if (parent == SegmentedButtonGroup.this && child instanceof RadioCheckable)
            {
                int id = child.getId();
